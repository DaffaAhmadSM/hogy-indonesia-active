...
@section('content')
    ...
    <div class="flex flex-col gap-0 max-h-full">
        <div class="flex align-middle justify-center">
            <h1 class="text-2xl font-bold mb-4">{{ $title }} {{ $state != 'active' ? $state : '' }}</h1>
        </div>
                ...
                <div class="container mx-auto px-4 py-2">
                    <div class="flex w-full max-w-md flex-col gap-1 text-neutral-600 px-4 py-2">
                        ...
                        <div class="flex flex-row gap-2 w-full items-end">
                            ...
                            <!-- Tombol Search -->
                            <button
                                hx-get="{{ route('report.product-bb-main.search', ['type' => $type, 'state' => $state]) }}"
                            ...
                            <!-- Tombol Export -->
                            <button
                                hx-post="{{ route('report.product-bb-main.export', ['type' => $type, 'state' => $state]) }}"
