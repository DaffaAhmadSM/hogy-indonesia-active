...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dapra/4_CODE/HOGY-INDONESIA/public/storage' => 'string',
...
'app.aliases.View','app.aliases.Vite','app.aliases.Excel','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.report','filesystems.links./home/dapra/4_CODE/HOGY-INDONESIA/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','octane.server',
...
'octane.max_execution_time','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'queue.connections.failover.driver','queue.connections.failover.connections','queue.batching.driver','queue.batching.database','queue.batching.table',
...
'signed','throttle','verified','custom.auth',);
        registerArgumentsSet('routes', 'telescope','livewire.update','livewire.upload-file','livewire.preview-file',
'home','login','logout','login.post','report.invent-in-main',
'report.invent-in-main.export','report.invent-in-main.search','report.invent-out-main','report.invent-out-main.export','report.invent-out-main.detail',
'report.invent-out-main.search','report.product-wip-main','report.product-wip-main.export','report.product-wip-main.search','report.product-wip-main.export.status',
'report.product-bb-main','report.product-bb-main.export','report.product-bb-main.search','report.product-bb-main.export.status','report.product-reject-main',
'report.product-reject-main.export','report.product-reject-main.search','report.product-scrap-main','report.product-scrap-main.export','report.product-scrap-main.search',
'storage.local',);
        registerArgumentsSet('views', 
'Export.excel.Invent-out-main','Export.excel.InventInMain','Report.invent-in-main','Report.invent-out-main','Report.product-bb-main',
'Report.product-reject-main','Report.product-scrap-main','Report.product-wip-main','Response.Report.InventInMain.search','Response.Report.InventOutMain.detail',
'Response.Report.InventOutMain.search','Response.Report.ProductBbMain.search','Response.Report.ProductReject.search','Response.Report.ProductWipMain.search','Response.hx.toast',
...
'components.hx.ProductWip.poll','components.hx.download-button','components.hx.pool','components.hx.toast','components.layouts.app',
...
'components.layouts.auth.split','components.loading-spinner','components.placeholder-pattern','components.settings.layout','dashboard',
...
'login','main-layout','partials.head','partials.settings-heading','welcome',
...
'e60dd9d2c3a62d619c9acb38f20d5aa5::otp.input','e60dd9d2c3a62d619c9acb38f20d5aa5::otp.separator','e60dd9d2c3a62d619c9acb38f20d5aa5::profile','e60dd9d2c3a62d619c9acb38f20d5aa5::radio.group.index','e60dd9d2c3a62d619c9acb38f20d5aa5::radio.group.variants.default',
...
'DB_PASSWORD','DB_ENCRYPT','DB_TRUST_SERVER_CERTIFICATE','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','QUEUE_FAILED_DRIVER','DB_QUEUE_CONNECTION','DB_QUEUE_TABLE','CACHE_STORE',
