...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/programming/Laravel/dbi_ecustom/public/storage','logging.default',
...
'home','report.invent-in-main','report.invent-in-main.search','dashboard',
...
'Report.invent-in-main','Response.Report.InventInMain.search','components.action-message','components.app-logo','components.app-logo-icon',
'components.auth-header','components.auth-session-status','components.layouts.app','components.layouts.app.header','components.layouts.app.sidebar',
'components.layouts.auth','components.layouts.auth.card','components.layouts.auth.simple','components.layouts.auth.split','components.placeholder-pattern',
'components.settings.layout','dashboard','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.book-open-text','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.chevrons-up-down','e60dd9d2c3a62d619c9acb38f20d5aa5::icon.folder-git-2',
...
'livewire.settings.password','livewire.settings.profile','main-layout','partials.head','partials.settings-heading',
...
'e60dd9d2c3a62d619c9acb38f20d5aa5::with-tooltip','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button','laravel-exceptions-renderer::components.editor',
